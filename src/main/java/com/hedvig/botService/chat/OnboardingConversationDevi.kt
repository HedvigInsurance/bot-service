    ...
    init {
        ...
        this.createChatMessage(
            MESSAGE_STUDENT_25K_LIMIT, WrappedMessage(
                MessageBodySingleSelect(
                    "Äger du något som du tar med dig utanför hemmet som är värt över 25${nbsp}000 kr som du vill försäkra? 💍",
                    Lists.newArrayList<SelectItem>(
        ...
        this.createChatMessage(
            ...
            MessageBodySingleSelect(
                "Om du har något som är värt mer än 25${nbsp}000 kr och som du har med dig på stan, så behöver du lägga till ett extra skydd för den saken!\u000CDet kallas objektsförsäkring, och du lägger enkelt till det i efterhand om du skaffar Hedvig",
                SelectOption("Jag förstår!", MESSAGE_50K_LIMIT_YES_YES)
            )
        )
    }
